        ...
        {
            {
                "en", new Dictionary<string, string>
                {
                    ...
                    { "tooltip_GlobalSearch", "Enable global search feature." },
                    ...
                    { "convTitle", "Recap Converter (Archive Tool)" },
                    { "convInputFolder", "Data Folder (.sch):" },
                    { "convSettingsGroup", "Conversion Settings" },
                    { "convResolution", "Resolution:" },
                    { "convFps", "FPS:" },
                    { "convCodec", "Codec:" },
                    { "convQuality", "Quality (CQ/CRF):" },
                    { "convQualityHint", "(lower = better)" },
                    { "convStartBtn", "START CONVERSION" },
                    { "convStatusWaiting", "Waiting..." },
                    { "convErrFolder", "Please select a valid folder." },
                    { "convErrFfmpeg", "ffmpeg.exe not found in application directory!" },
                    { "convErrNoFiles", "No .sch files found." },
                    { "convLogFound", "Found files: {0}. Encoder: {1}, FPS: {2}" },
                    { "convLogDone", "=== DONE ===" },
                    { "convMsgSuccess", "All tasks completed." },
                    { "convLogCritical", "CRITICAL ERROR: {0}" },
                    { "convLogProcessing", "Processing file: {0}..." },
                    { "convLogNoFrames", "No frames to process." },
                    { "convLogStartFfmpeg", "Frames: {0}. Starting FFmpeg..." },
            ...
            },
            {
                "ru", new Dictionary<string, string>
                {
                    ...
                    { "tooltip_GlobalSearch", "Включить функцию глобального поиска." },
                    ...
                    { "convTitle", "Recap Конвертер (Архиватор)" },
                    { "convInputFolder", "Папка с данными (.sch):" },
                    { "convSettingsGroup", "Настройки конвертации" },
                    { "convResolution", "Разрешение:" },
                    { "convFps", "FPS:" },
                    { "convCodec", "Кодек:" },
                    { "convQuality", "Качество (CQ/CRF):" },
                    { "convQualityHint", "(меньше = лучше)" },
                    { "convStartBtn", "НАЧАТЬ КОНВЕРТАЦИЮ" },
                    { "convStatusWaiting", "Ожидание..." },
                    { "convErrFolder", "Выберите корректную папку." },
                    { "convErrFfmpeg", "ffmpeg.exe не найден в папке с программой!" },
                    { "convErrNoFiles", "Файлы .sch не найдены." },
                    { "convLogFound", "Найдено файлов: {0}. Кодировщик: {1}, FPS: {2}" },
                    { "convLogDone", "=== ГОТОВО ===" },
                    { "convMsgSuccess", "Все задачи выполнены." },
                    { "convLogCritical", "КРИТИЧЕСКАЯ ОШИБКА: {0}" },
                    { "convLogProcessing", "Обработка файла: {0}..." },
                    { "convLogNoFrames", "Нет кадров для обработки." },
                    { "convLogStartFfmpeg", "Кадров: {0}. Запуск FFmpeg..." },
            ...
            },
            {
                "uk", new Dictionary<string, string>
                {
                    ...
                    { "tooltip_GlobalSearch", "Увімкнути функцію глобального пошуку." },
                    ...
                    { "extWarnOpenFolder", "Відкрити директорію розширення" },
                    ...
                    { "convTitle", "Recap Конвертер (Архіватор)" },
                    { "convInputFolder", "Папка з даними (.sch):" },
                    { "convSettingsGroup", "Налаштування конвертації" },
                    { "convResolution", "Розмір:" },
                    { "convFps", "FPS:" },
                    { "convCodec", "Кодек:" },
                    { "convQuality", "Якість (CQ/CRF):" },
                    { "convQualityHint", "(менше = краще)" },
                    { "convStartBtn", "РОЗПОЧАТИ КОНВЕРТАЦІЮ" },
                    { "convStatusWaiting", "Очікування..." },
                    { "convErrFolder", "Оберіть коректну теку." },
                    { "convErrFfmpeg", "ffmpeg.exe не знайдено поруч з програмою!" },
                    { "convErrNoFiles", "Файли .sch не знайдено." },
                    { "convLogFound", "Знайдено файлів: {0}. Кодувальник: {1}, FPS: {2}" },
                    { "convLogDone", "=== ГОТОВО ===" },
                    { "convMsgSuccess", "Всі завдання виконано." },
                    { "convLogCritical", "КРИТИЧНА ПОМИЛКА: {0}" },
                    { "convLogProcessing", "Обробка файлу: {0}..." },
                    { "convLogNoFrames", "Немає кадрів для обробки." },
                    { "convLogStartFfmpeg", "Кадрів: {0}. Запуск FFmpeg..." },
